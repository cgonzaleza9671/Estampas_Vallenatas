...
sed -i '208,284c\
              <div className="flex flex-col md:flex-row gap-4 items-center w-full">\
                ...
                <button onClick={resetFilters} className="shrink-0 flex items-center gap-2 w-full md:w-auto px-6 py-4 rounded-2xl bg-gray-50 text-gray-500 hover:bg-gray-100 hover:text-vallenato-red transition-all text-xs font-bold uppercase tracking-widest border-2 border-transparent">\
